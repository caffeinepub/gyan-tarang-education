  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        card: "0 2px 12px oklch(0.22 0.12 260 / 0.08)",
        "card-hover": "0 8px 25px oklch(0.22 0.12 260 / 0.15)",
        saffron: "0 4px 15px oklch(0.72 0.18 55 / 0.3)",
        navy: "0 4px 15px oklch(0.22 0.12 260 / 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
